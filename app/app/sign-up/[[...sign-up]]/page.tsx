...
const sellingPoints = [
  ...
  "Ready for onboarding without changing response controls.",
];
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="max-w-xl space-y-4">
              <h1 className="text-4xl font-semibold tracking-tight text-[#F0F6FC] sm:text-5xl">
                Create your PhishSlayer account
              </h1>
              <p className="max-w-lg text-sm leading-7 text-text-sec sm:text-base">
                Start in a high-contrast workspace shell that keeps analyst identity, org context, and response rails easy to read.
              </p>
            </div>
          </div>
